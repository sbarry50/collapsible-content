 ...
 *
 * @package     SB2Media\CollapsibleContent\Shortcode
 * @since       1.0.0
 * @author      sbarry50
...
namespace SB2Media\CollapsibleContent\Shortcode;
...
/**
 * Get the runtime configuration parameters of the specified shortcode
 *
 * @since 1.0.0
 *
 * @param   string $shortcode_name Name of the shortcode
