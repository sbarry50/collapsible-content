<div class="collapsible-content--container teaser" itemscope itemtype="http://schema.org/BlogPosting">
  <div class="collapsible-content--visible" itemprop="headline">
      <span class="collapsible-content--icon <?php echo $attributes['show_icon']; ?>" aria-hidden="true" data-show-icon="<?php echo $attributes['show_icon']; ?>" data-hide-icon="<?php esc_attr_e( $attributes['hide_icon'] ); ?>">
          <span class="screen-reader-text">Click to reveal the message</span>
      </span>
      <?php esc_html_e( $attributes['visible_message'] ); ?>
  </div>
  <div class="collapsible-content--hidden" itemprop="description" itemscope itemtype="http://schema.org/Answer" style="display: none;">
